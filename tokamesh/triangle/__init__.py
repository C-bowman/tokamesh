...
def run_triangle(
    outer_boundary=None, inner_boundary=None, void_markers=None, max_area=None
):
    """
    ...
    if triangle_dir is None:
        ...
        subprocess.call(
            triangle_dir + "triangle -pqa" + area + " " + inputfile, shell=True
        )
    ...
    b_x = array(
        inner_r[:-1]
    )  # get the boundary coords - these are the 'correct' values
    b_y = array(inner_z[:-1])
